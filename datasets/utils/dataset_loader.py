...
def get_dataset(params):
    ...
    if dataset_name == "nabirds":
        ...
        train_dataset = NABirds(
            root=data_root, transform=transform, train=True, class_list=class_list
        )
        test_dataset = NABirds(
            root=data_root, transform=test_transform, train=False, class_list=class_list
        )
        dataset = NABirds(
            root=data_root, transform=transform, train=None, class_list=class_list
        )
    ...
    if dataset_name == "nabirds_modified":
        ...
        modified_params = {
            ...
            "modified_classes": params["transform_params"]["synthetic_concept_config"][
                "train"
            ]["concept_params"]["classes"],
        }
        train_dataset = NABirds(
            root=data_root,
            transform=transform,
        ...
        modified_test_params = {
            "transform": modified_test_transform,
            "modified_classes": params["transform_params"]["synthetic_concept_config"][
                "test"
            ]["concept_params"]["classes"],
        }
        test_dataset = NABirds(
            ...
            train=False,
            modified_params=modified_test_params,
        )
        dataset = NABirds(
            root=data_root,
            transform=transform,
    ...
    if dataset_name == "imagenet":
        ...
        train_dataset = ImageNetModified(
            root=data_root,
            split="train",
            transform=transform,
            concept_params=concept_params,
        )
        test_dataset = ImageNetModified(
            root=data_root,
            split="val",
            transform=test_transform,
            concept_params=concept_params,
    ...
    if dataset_name == "stanford_cars":
        ...
        train_dataset = torchvision.datasets.StanfordCars(
            root=data_root, split="train", transform=transform
        )
    ...
    if dataset_name == "nabirds_stanford_cars":
        ...
        train_dataset = NABirdsStanfordCars(
            root=data_root, transform=transform, train=True, class_list=class_list
        )
        test_dataset = NABirdsStanfordCars(
            root=data_root, transform=test_transform, train=False, class_list=class_list
        )
        dataset = NABirdsStanfordCars(
            root=data_root, transform=transform, train=None, class_list=class_list
        )
