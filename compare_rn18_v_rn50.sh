...
python compare_models.py --dataset_split_0 val --dataset_split_1 val \
--comparison_config ./comparison_configs/r18_flv=v1_vs_r50_flv=v1-nmf=10_seed=0.json \
--start_class_idx 0 --end_class_idx 100 --concept_root_folder_0 /scratch/$(whoami)/rsvc-exps/ \
--concept_root_folder_1 /scratch/$(whoami)/rsvc-exps/ # --folder_exists overwrite 
